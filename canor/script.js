...
scrollContainer.addEventListener("scroll", () => {
    ...
    console.log('current', current, 'menu footer', menuFooter);
    if (current === "cover") {  // replace "cover" with your first section id
        menuFooter.style.cssText += "opacity: 1; pointer-events: auto; transition: opacity 0.3s ease;";
        topBar.style.cssText += "opacity: 1; pointer-events: auto; transition: opacity 0.3s ease;";
    } else {
        menuFooter.style.cssText += "opacity: 0; pointer-events: none; transition: opacity 0.3s ease;";
        topBar.style.cssText += "opacity: 0; pointer-events: none; transition: opacity 0.3s ease;";
    }
});
